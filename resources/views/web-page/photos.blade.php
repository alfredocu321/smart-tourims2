    ...
    <section class="font-[sans-serif] py-4 mx-auto lg:max-w-6xl max-w-lg md:max-w-full">
        ...
        <div class="mx-auto mt-5 w-screen max-w-screen-md py-20 leading-6">
            <form action="{{ route('photo') }}" method="GET"
                class="relative flex flex-col sm:flex-row items-center w-full justify-between rounded-lg border p-2">
                <div class="flex-grow w-full sm:mr-2">
                    <input type="text" name="search" value="{{ request('search') }}"
                        class="h-14 w-full cursor-text rounded-md border py-4 pl-6 outline-none ring-emerald-200 sm:pl-12 focus:ring"
                        placeholder="Product name" />
                </div>
                <button type="submit"
                    class="mt-2 sm:mt-0 inline-flex h-12 w-full sm:w-auto items-center justify-center rounded-md bg-emerald-500 px-10 text-center align-middle text-base font-medium normal-case text-white outline-none ring-emerald-200 ring-offset-1 focus:ring">Search</button>
            </form>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            @forelse ($photos as $photo)
                <div
                    ...
                    <div
                        ...
                        <img src={{ asset('storage/' . $photo->media->path) }} alt="ui/ux review check" />
                        <div
                    ...
                    <div class="p-6 pt-3">
                        <a href={{ route('image360', ['id' => $photo->id]) }}
            ...
            @empty
                <p class="col-span-1 md:col-span-2 lg:col-span-3 text-center">No photos found.</p>
            @endforelse
        </div>
    </section>
@endsection
